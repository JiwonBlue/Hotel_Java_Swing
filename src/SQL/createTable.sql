...
CREATE TABLE MEMBER_TABLE(
	MEMBER_ID VARCHAR(10) NOT NULL constraint MEMBER_ID_PK primary key, --회원정보code(PK)
	MEMBER_PWD VARCHAR(10) NOT NULL, --비밀번호
...
CREATE TABLE RESERVE_TABLE(
	RESERVE_CODE VARCHAR2(10) NOT NULL constraint RESERVE_CODE primary key, --예약code(PK)
	MEMBER_ID VARCHAR2(10) NOT NULL constraint RESERVE_MEMBER_ID_FK references MEMBER_TABLE(MEMBER_ID), --회원정보code(FK)
...
insert into MEMBER_TABLE values('p123', 'u12345', '엄용민', '010-9999-9888', '1999-06-28', '내국인');
insert into MEMBER_TABLE values('t123', 'j12345', '조용태', '010-7799-8787', '1966-09-28', '내국인');
insert into MEMBER_TABLE values('y123', 's12345', '강찬성', '010-6663-8558', '1970-05-22', '내국인');


insert into RESERVE_TABLE values('reserve'||RESERVE_TABLE_SEQ.nextval, 'p123', 'room101', '2023-07-15', '2023-07-17', 3);
insert into RESERVE_TABLE values('reserve'||RESERVE_TABLE_SEQ.nextval, 'p123', 'room102', '2023-07-15', '2023-07-17', 3);
insert into RESERVE_TABLE values('reserve'||RESERVE_TABLE_SEQ.nextval, 't123', 'room202', '2023-07-15', '2023-07-17', 3);
insert into RESERVE_TABLE values('reserve'||RESERVE_TABLE_SEQ.nextval, 't123', 'room203', '2023-07-15', '2023-07-17', 3);
insert into RESERVE_TABLE values('reserve'||RESERVE_TABLE_SEQ.nextval, 'y123', 'room302', '2023-07-15', '2023-07-17', 3);
insert into RESERVE_TABLE values('reserve'||RESERVE_TABLE_SEQ.nextval, 'y123', 'room303', '2023-07-15', '2023-07-17', 3);
